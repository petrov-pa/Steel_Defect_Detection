...
def augmentation():
    """ Возвращает pipeline преобразований. """
    transform = A.Compose([
...
def get_mask(name, df):
    """Декодирует разметку дефекта и возвращает в числового массива.
    Parameters:
    name -- название файла (str)
    df -- таблица с информацией о дефекте (DataFrame)
    Returns:
        numpy array
    """
