...
#### Пайплайн обучения
![image](https://drive.google.com/uc?export=view&id=1wgQxs2Pe6lB9q-smkP3ow5zoCCzcVM2a)
...
#### Запуск пайплайна обучения
    ...
    dvc repro evaluate_classifier # для проверки качества классификатора
    dvc repro evaluate_segmentation # для проверки качества сегментации

#### Просмотр метрик моделей
    dvc metrics show
